...
# Minimal Pygame window setup
import pygame
pygame.init()
screen = pygame.display.set_mode((WIDTH + CELL_SIZE, HEIGHT))
pygame.display.set_caption("Maze Assignment - Initial Grid Setup")

# Main loop (window only, no drawing)
running = True
while running:
